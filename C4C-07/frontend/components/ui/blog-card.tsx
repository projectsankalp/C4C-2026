...
export const ArticleCard: React.FC<ArticleCardProps> = ({
  ...
  return (
    <Card className="flex w-full max-w-sm flex-col gap-3 overflow-hidden rounded-3xl border p-3 shadow-lg bg-white/70 backdrop-blur-md hover:shadow-xl transition-shadow duration-300">
      {cover && (
      ...
      {hasFooter && (
        <CardFooter className="flex items-center justify-between p-3 border-t border-slate-100 pt-4">
          {writer && (
            <div>
