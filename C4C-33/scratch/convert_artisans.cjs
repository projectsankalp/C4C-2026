...
fileContent = fileContent
  ...
  .replace(/నేను రాಮ್ స్వరూప్/g, 'నేను రాధา దేవి')
...
fileContent = fileContent
  ...
  .replace(/শিবরাম একজন विशेषज्ञ/g, 'శాంతి ఒక నిపుణుడు')
...
fileContent = fileContent
  ...
  .replace(/అస్సలాము అలైకుమ్, నా పేరు ఫಾతిమా/g, 'అస్సలాము అలైకుమ్, నా పేరు ఫాతిమా')
  ...
  .replace(/பாத்திมา 'கானி'/g, 'பாத்திமா \'கானி\'')
  .replace(/ফাতিমা 'কানি'/g, 'ফাতিমা \'কانی\'')
...
fileContent = fileContent
  ...
  .replace(/मी सागरमधून देवम्मा/g, 'मी सागरमधून देवಮ್ಮ बोलतोय')
